...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">List Admins</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                Edit Admins</span>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12 margin-tb">
                    ...
                    <form action="{{route('admin.product-categories.update',$ProductCategory->id)}}" enctype="multipart/form-data" method="post">
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-3" id="fnWrapper">
                                ...
                                <select name="category_id" class="form-control">
                                    ...
                                    <option value="{{ $Category->id }}" {{ old('category_id',$ProductCategory->category_id) == $Category->id ? 'selected' : null }}>{{ $Category->name }}</option>
                                    @empty
                                    @endforelse
                                </select>
