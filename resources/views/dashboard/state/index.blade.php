            ...
            <div class="card-header pb-0">
                ...
                <!--end Modal create -->
                    ...
                    <div class="col-xl-4 col-md-4 row align-items-center justify-content-end">
                        <form class="form-inline" action="{{ route('admin.state.index') }}" method="GET">
                    ...
                    <table class="table table-hover"  style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-10p border-bottom-0">Country</th>
                        ...
                        <tbody>
                            @forelse ($states as $key => $state)
                                ...
                                <!--start Modal Update -->
                                    <div class="modal" id="update-{{ $state->id }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                ...
                                                <form action="{{ route('admin.state.update',$state->id ) }}" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label for="name">name</label>
                                                                <input class="form-control" value="{{$state->name}}"  name="name" id="name" type="text">
                                                            </div>
                                                            <div class="form-group">
                                                                <select name="status" class="form-control">
                                                                    <option value="1" {{$state->status == 1 ? 'selected' : null; }}>Active</option>
                                                                    <option value="0" {{$state->status == 0 ? 'selected' : null; }}>Inactive</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                <select name="country_id" class="form-control">
                                                                    @foreach ($countries as $country)
                                                                        <option value="{{$country->id}}" {{$country->id == $state->country_id ? 'selected' : null; }}>{{$country->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                ...
                                <!--start Modal delete -->
                                <div class="modal" id="modaldemo-{{ $state->id }}">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('admin.state.destroy',  $state->id) }}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <p>Sure Delete</p><br>
                                                    <input type="hidden" value="{{ $state->id }}" name="id" id="user_id">
                                                    <input class="form-control" value="{{ $state->name }}" name="username" id="username" type="text" readonly>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">back</button>
