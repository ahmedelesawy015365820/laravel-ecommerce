            ...
            <div class="card-header pb-0">
                ...
                <!--end Modal create -->
                    ...
                    <div class="col-xl-4 col-md-4 row align-items-center justify-content-end">
                        <form class="form-inline" action="{{ route('admin.city.index') }}" method="GET">
                    ...
                    <table class="table table-hover"  style=" text-align: center;">
                        ...
                        <tbody>
                            @forelse ($cities as $key => $city)
                                ...
                                <!--start Modal Update -->
                                    <div class="modal" id="update-{{ $city->id }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                ...
                                                <form action="{{ route('admin.city.update',$city->id ) }}" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="name">name</label>
                                                            <input class="form-control" value="{{ $city->name }}" name="name" id="name" type="text">
                                                        </div>
                                                        <div class="form-group">
                                                            <select name="status" class="form-control">
                                                                <option value="1" {{$city->status == 1 ? 'selected' : null; }}>Active</option>
                                                                <option value="0" {{$city->status == 0 ? 'selected' : null; }}>Inactive</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <select name="state_id" class="form-control">
                                                                @foreach ($states as $state)
                                                                    <option value="{{$state->id}}" {{$state->id == $city->state_id ? 'selected' : null; }}>{{$state->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                ...
                                <!--start Modal delete -->
                                <div class="modal" id="modaldemo-{{ $city->id }}">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content modal-content-demo">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('admin.city.destroy', $city->id ) }}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <p>Sure Delete</p><br>
                                                    <input class="form-control" value="{{ $city->name }}" name="username" id="username" type="text" readonly>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">back</button>
