...
@section('content')
        ...
        <section class="py-5">
          ...
          <div class="row">
              ...
              <div class="table-responsive mb-4">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <livewire:fronted.cart-item-component :item="$item->rowId" :key="$item->rowId" />
                    @empty
                      <tr>
                          <td colspan="5"><p class="text-center">No Item Found In Your Cart!</p></td>
                      </tr>
                    @endforelse
                  </tbody>
                </table>
                ...
                <div class="row align-items-center text-center">
                  ...
                  <div class="col-md-6 text-md-right">
                    ...
                    <a class="btn btn-outline-dark btn-sm" href="{{route('frontend.checkout')}}">
                        Procceed to checkout<i class="fas fa-long-arrow-alt-right ml-2">
                            </i>
                    </a>
                    @endif
                </div>
            ...
            <!-- ORDER TOTAL-->
            <livewire:fronted.cart-total-component />
          </div>
        </section>
