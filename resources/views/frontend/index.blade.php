...
@section('content')
      ...
      <!-- HERO SECTION-->
        ...
        <section class="pt-5">
          ...
          <div class="row">
            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="{{route('frontend.shop',$categories[0]->slug)}}">
                    <img class="img-fluid" src="{{asset("assets/img/Category/cat-img-1.jpg")}}" alt="Clothes">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                <a class="category-item mb-4" href="{{route('frontend.shop',$categories[1]->slug)}}">
                    <img class="img-fluid" src="{{asset("assets/img/Category/cat-img-2.jpg")}}" alt="Shoes">
                    <strong class="category-item-title">Shoes</strong>
                </a>
                <a class="category-item" href="{{route('frontend.shop',$categories[2]->slug)}}">
                    <img class="img-fluid" src="{{asset("assets/img/Category/cat-img-3.jpg")}}" alt="Watches">
                    <strong class="category-item-title">Watches</strong>
                </a>
            </div>
            <div class="col-md-4">
                <a class="category-item" href="{{route('frontend.shop',$categories[3]->slug)}}">
                <img class="img-fluid" src="{{asset("assets/img/Category/cat-img-4.jpg")}}" alt="Electronics">
        ...
        <!-- TRENDING PRODUCTS-->
        <livewire:fronted.fronted-product>
        <!-- SERVICES-->
