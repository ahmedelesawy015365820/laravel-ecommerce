				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            <livewire:backend.nabar.notification-component />
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="{{ route('admin.profile.index') }}"><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href="{{ route('admin.profile.create') }}"><i class="bx bx-cog"></i> Edit Profile</a>
