...
class AdressesComponent extends Component
{

    public  $status= false, $editMode = false, $addresses;
    public $address_id = '';
    public $address_title = '';
    public $default_address = false;
    public $first_name = '';
    public $last_name = '';
    public $email = '';
    public $mobile = '';
    ...
    public function addAddress()
    {
        ...
        $address = auth()->guard('customer')->user()->addresses()->create([
        ...
        if ($this->default_address) {
            auth()->guard('customer')->user()->addresses()->where('id', '!=', $address->id)->update([
    ...
    public function Update_address()
    {
        ...
        $address = auth()->guard('customer')->user()->addresses()->where('id', $this->address_id)->update([
            "address_title" => $this->address_title,
            "default_address" => $this->default_address,
            "first_name" => $this->first_name,
            "last_name" => $this->last_name,
        ...
        if ($this->default_address) {
            auth()->guard('customer')->user()->addresses()->where('id', '!=', $this->address_id)->update([
                'default_address' => false
            ]);
        }
    ...
    {
        $address = auth()->guard('customer')->user()->addresses()->where('id', $id)->first();
    ...
    public function render()
    {
        ...
        return view('livewire.fronted.customer.adresses-component', [
